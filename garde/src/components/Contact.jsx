...
const Contact = () => {
  ...
  return (
    ...
    <div className="">
        ...
        <div className="mt-16">
          <h1 className="text-center text-white text-7xl font-extrabold font-platypi"> Contact Us. </h1>
        </div>

        <div className="flex justify-center mt-10">
          <h4 className="text-white font-platypi mt-5 text-xl">If you are a coach and want to use Garde, please fill out the form below. <br/> We will get in touch with you soon. </h4> 
        </div>                                  

    </div>
    
    <div className="bg-gray-700 mt-[100px] ml-[300px] rounded-xl w-[700px] h-[600px]">
